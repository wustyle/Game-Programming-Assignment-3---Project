...
public class NPC {
    ...
    public NPC (JFrame w, Player p, int X, int Y, String n)
    {
        ...
        if(name == "Jon"){
            ...
            lines.add("Thank you!");
            lines.add("Also, there's a big scary Monster, he's called the King of the Forest! Don't attempt to fight him unless you are experienced enough. You need to have at least 10 levels.");
